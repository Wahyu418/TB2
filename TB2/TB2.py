...
# Tes penambahan buku 
# curl -X POST "http://127.0.0.1:8000/buku" -H "Content-Type: application/json" -d "{\"judul\": \"Mathematics for Machine Learning\", \"penulis\": \"Marc Peter Deisenroth\", \"penerbit\": \"Cambridge University Press\", \"tahun_terbit\": 2020, \"konten\": \"['Chapter 1: Introduction', 'Chapter 2: Linear Algebra', 'Chapter 3: Calculus']\", \"iktisar\": \"This book provides a comprehensive introduction to the mathematical concepts needed for machine learning.\"}"

# tes penarikan buku
# curl -X GET "http://127.0.0.1:8000/buku/Mathematics%20for%20Machine%20Learning"
